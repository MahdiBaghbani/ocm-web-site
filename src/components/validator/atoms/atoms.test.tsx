...
function rootCardTag(html: string): string {
  return firstTag(html, /<div[^>]*>/, "root card");
}

function primaryButtonTag(html: string): string {
  return firstTag(html, /<button[^>]*>/, "primary button");
}

function guidanceSlotTag(html: string): string {
  return firstTag(html, /<div[^>]*data-guidance-slot[^>]*>/, "guidance slot");
}

function statusCaptionTag(html: string): string {
  return firstTag(
    html,
...
function ctaSlotTag(html: string): string {
  return firstTag(html, /<div[^>]*data-cta-slot[^>]*>/, "cta slot");
}

function secondaryLinkTag(html: string): string {
