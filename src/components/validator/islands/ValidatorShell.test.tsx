...
describe("ValidatorShell entry form", () => {
  test("renders the form-first labels, hints, fieldset, and primary action", () => {
    ...
    expect(html).toContain("Anyone with the link can view it. The retention policy applies.");
    expect(html).toContain("Run active validation");
    expect(html).toContain("Tests live sharing steps and may ask you to complete actions.");
    expect(html).toContain("Contribute to public statistics");
    expect(html).toContain("Adds aggregate data after privacy thresholds. No public server report.");
