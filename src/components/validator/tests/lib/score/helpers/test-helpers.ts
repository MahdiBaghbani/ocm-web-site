...
import { CANONICAL_AREA_IDS, type CanonicalAreaId } from "@/components/validator/lib/score/areas";
import type { SpecificationAreaScore, SpecificationGrade } from "@/components/validator/lib/score/parse";
